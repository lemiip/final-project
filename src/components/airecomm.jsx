...
<a href={productDetailsUrl(`Chosen For You-${recom.id}`)} className="relative block">
<img
...
<div className="flex justify-between items-start mt-4">
  <a href={productDetailsUrl(`Chosen For You-${recom.id}`)} className="
font-bold
cursor-pointer
flex-1
min-w-0
...
break-words
">
<a href={productDetailsUrl(`Chosen For You-${recom.id}`)} className="hover:underline">
{recom.text}
</a>
</h3>
